...
should be able to apply measure also to 'non-ground-truth' effects. E.g. when using autoencoder or other method to find "concepts" that can be turned on and off. 
