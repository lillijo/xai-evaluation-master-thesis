...
% Comment Oana: motivation for causality is missing
...
\begin{itemize}
    ...
    \item introduce "causal" biases into dataset, by adding small watermark not uniformly to certain images % comment Oana: actually should be "generate data with known ground truth - use causality"
...
\begin{itemize}
    ...
    \item what do we want to explain % comment Oana : this should be first, and i think it should be more like "a measure for quantifying influence of bias on explanation / model" 
    \item does this result generalize for other attribution methods, data, SCMs?
\end{itemize}

\subsubsection*{Conclusions}
\begin{itemize}
    \item found a new benchmark measure to combat the critique about the robustness and fidelity of especially concept-based methods. % comment Oana - not sure exactly what you mean by this, but it sounds more than we actually do. is this more like future work?
    \item from that new method a way to enrich or improve those methods arises % comment Oana - we don't actually do this
