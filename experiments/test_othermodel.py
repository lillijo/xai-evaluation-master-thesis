...
def train_model_with_bias(bias, lr):
    strength = 0.5
    batch_size = 128
    name = "outputs/test"
    ...
    accs = accuracy_per_class(model, train_loader, disable=False)
    print(accs)
    return accs
...
if __name__ == "__main__":
    ...
    parser.add_argument("lr", help="lr float", type=float)
    args = parser.parse_args()
    train_model_with_bias(args.bias, args.lr)
